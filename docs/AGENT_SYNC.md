...
| I7 | **Dự phòng nếu xong hết I1-I6 mà vẫn còn thời gian:** lặp lại I1 với `--seed` khác (vd 1) cho cả nhánh B và C, so `event_based_f1`/`psds` giữa 2 seed — bằng chứng biến thiên giữa các lần chạy trước khi coi số ở I5 là ổn định. Không bắt buộc, không chặn gì | Codex | `ml/runs/` | I5 | 🔒 codex 10:15 |
